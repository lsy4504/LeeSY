...
/**
 * 특정 조건(URIMappingCondition)에 해당하는 요청을 처리할 수 있는 핸들러 객체와 메소드에 대한 정보를 가진 객체
 * 
 */
public class URIMappingInfo {
	...
	public String toString() {
		return "URIMappingInfo [commandHandler=" + commandHandler + ", handlerMethod=" + handlerMethod + "]";
	}
